          ...
          <div className='w-3/5 p-5'>
            ...
            <div className='flex flex-col items-center'>
              <div className='bg-gray-300 w-64 p-2 flex items-center mb-3'>
                ...
                <input type="text" name="username" placeholder="Username" className='bg-gray-300 outline-none test-sm flex-1'></input>
              </div>
              ...
              <a href='#' className='mt-5 rounded-full border-green-500 text-green-500 border-2 px-12 py-2 inline-block font-semibold hover:bg-green-500 hover:text-white'>Sign in</a>
            </div>{/*input fields */}
